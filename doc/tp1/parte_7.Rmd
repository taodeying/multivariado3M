...
originado por los ACP
    ...
    hay una concordancia media entre las condfiguraciones de las poblaciones en 
    ambos ambientes.
...
ambiente y las 3 con menor efecto
    ...
    Me falta decir cuales son las 3 con mayor efecto ambiente, y las 3 con menor.

A) Comparar lo encontrado en h) con el ANOVA correspondiente. Realice comentarios

    No van a coincidir porque el dibujo esta en 2d y el ANOVA usa a las 10 dimensiones 
    para calcular la suma de cuadrados residual.