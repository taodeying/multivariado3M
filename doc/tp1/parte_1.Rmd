...
ggplot() + 
  geom_point(datos_cp, aes(pc1, pc2), size = 4, color = "gray30") + 
  geom_label_repel(aes(pc1, pc2, label = VARIEDAD)) + 
  geom_vline(xintercept = 0, linetype = "solid") + 
  geom_hline(yintercept = 0, linetype = "solid") + 
  labs(
...
ggplot(min_data) +
  ...
  geom_point(aes(cophenetic_min,matriz_distancia_std_dist ), size = 3, alpha = 0.7, color = "grey30")+
  theme_classic()+
...
ggplot(comp_data) +
  geom_abline(slope = 1, size = 1.2, alpha = 0.8, color = colores[1]) +
  geom_point(aes(cophenetic_comp,matriz_distancia_std_dist ), size = 3, alpha = 0.7, color = "grey30")+
  theme_classic()+
...
ggplot(upgma_data) +
  geom_abline(slope = 1, size = 1.2, alpha = 0.8, color = colores[1]) +
  geom_point(aes(cophenetic_upgma,matriz_distancia_std_dist ), size = 3, alpha = 0.7, color = "grey30")+
  theme_classic()+
...
ggplot(ward_data) +
  geom_abline(slope = 1, size = 1.2, alpha = 0.8, color = colores[1]) +
  geom_point(aes(cophenetic_ward,matriz_distancia_std_dist ), size = 3, alpha = 0.7, color = "grey30")+
  theme_classic()+
