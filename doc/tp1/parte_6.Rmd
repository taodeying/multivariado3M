...
```
    ...
    Para cada configuracion medida en los pepinos (cualitativa, cuantitativa y
...
```
    ...
    cualitativa y molecular es de `r conc_2_5`, indicando de esta forma una concordancia
    media-alta.
