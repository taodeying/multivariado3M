...
matriz_distancia <- dist(datos_df, method = "manhattan") / 33
```
...
```{r}
distancia_cofenetica <- cophenetic(cluster_molecular)
concordancia <- cor(matriz_distancia, distancia_cofenetica)
```
