...
\StringTok{    }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{media =} \KeywordTok{round}\NormalTok{(}\KeywordTok{mean}\NormalTok{(SSresidual),}\DecValTok{2}\NormalTok{)) }\OperatorTok{%>%}
...
\StringTok{    }\KeywordTok{kable_styling}\NormalTok{(}\DataTypeTok{font_size =} \DecValTok{12}\NormalTok{, }\DataTypeTok{full_width =} \OtherTok{FALSE}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
