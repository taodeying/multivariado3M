...
`r paste0(round(similaridad_1_2, 2), "%")`. Luego, de manera análoga para el 
...
matriz_distancia <- daisy(datos_fct_df, "gower")
...
```{r, fig.cap="Figura 1: Caracterizacion cualitativa de las variedades de pepino.", class.source="fold-hide"}
ggplot(datos_CP) + 
...
En el dendograma se muestran coloreados los 4 clusters obtenidos.
