...
El género de hongos BO posee notable variedad a lo largo de las estaciones, 
...
a AL. Notese que si se grafican las correlaciones, se obtienen los mismos resultados:
...
la zona centro de la este. A su vez, se se proyectaran los datos los 
...
selección de los establecimientos productivos. Respecto a las variedades de hongos,
se nota que existe una gran variabilidad de resultados en las frecuencias a medida
que cambian las estaciones. Cabe destacar los resultados de la variedad BO, ya que
presentó una fuerte concordancia en sus resultados a lo largo de las estaciones, y 
se espera que se adapte bien a aquellos establecimientos con métodos de cultivos
orgánicos. Se espera que los establecimientos de la zona centro puedan aprovechar específicamente 
dicha variedad.
