...
El coeficiente $L_g$ demustra que entre otoño e invierno, comparten mucha inercia. 
...
El coeficiente $N_g$ demuestra que los grupos de verano y primavera se los puede 
...
```{r, fig.width = 6, fig.height = 6, out.width="60%", fig.cap="AGREGAR"}
...
```{r, fig.width=7, fig.height=5, fig.cap="AGREGAR"}
...
```{r, fig.width=8, fig.height=4, fig.cap="AGREGAR"}
