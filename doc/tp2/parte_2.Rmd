...
```{r, fig.cap="Comparacion de distancias en el plano principal para ACP y ACM."}
    ...
    El grafico nos permite ver que las representaciones sobre el plano principal
    no son concordantes. La correlacion entre las distancias 
...
A) Realice el análisis de la interestructura. ¿Qué puede decir de la relación existe entre los grupos?
    ...
    Las variables Cualitativas que más aportan en la formación del eje 2 son Color
    de Estrías y de Panoja a fin de antesis Púrpura
    ...
    Las variables cuantitativas que más aportan en la formación del eje 1 son: 
    altura de planta, diámetro del tallo, longitud de la panoja, Días de siembra
    a botón floral y días desde siembre a floración. Es decir, aquellos individuos
    que posean valores altos de la primer componente van a tener...COMPLETAR
A) ¿Existe un agrupamiento de individuos por zona?
    ...
    Al observar la figura VER NUMERO Q CORRESPONDE podemos referenciar algunos 
    agrupamientos según la zona de procedencia. El primer grupo es el conformado 
    por las variedades VA466 y VA465, procedentes de Valles de Altura; el resto
    de las variedades de Valles de Altura pueden asociarse en un segundo grupo.
    El tercer grupo que puede identificarse está conformado por las variedades 
    procedentes de Altiplano; y por último, el cuarto agrupamiento se compone por 
    las que son procedentes de Valles Húmedos y Secos. 
    Cabe descatar que hay dos "individuos", VS414 y VH458, que se alejan del cuarto
    agrupamiento. Es muy probable que estos valores extremos se deban a que presenten 
    valores más altos en la configuración Cualitativa.
...
A) Caracterice los grupos de individuos a través de todas las variables.
    ...
    Las variedades VA466 y VA465, las cuales conforman el primer grupo, se 
    caracterizan por tener el color de las estrias y de la panoja a fin de antesis
    de color púrpura. Además, estas variedades tienen un comportamiento promedio
