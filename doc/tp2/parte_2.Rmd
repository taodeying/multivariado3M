...
A) Realice un ACP con las variables cuantitativas.
    ...
    longitud, ancho de hoja y longitud del peciolo (de forma positiva) y días 
    desde siembra hasta la aparicion del botón floral, hasta la floración, y 
    hasta la madurez fisiológica (de forma negativa).
...
A) Realice el análisis de la interestructura. ¿Qué puede decir de la relación existe entre los grupos?
    ...
    Las variables Cualitativas que más aportan en la formación del eje 2 son 
    Color de Estrías y de Panoja a fin de antesis Púrpura.
    ...
    Todas las variables cuantitativas contribuyen a la construccion del primer
    eje. El grupo de variables que mas contribuye es el de medidas morfologicas
    de la planta. Los otros dos grupos, de medidas morfologicas de la hoja
    y de caracteristicas temporales, contribuyen de menor manera. Esto nos
    permite decir que individuos que presenten valores altos en la primer 
